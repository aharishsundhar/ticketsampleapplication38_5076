...
APPLICATION='/ticketsampleapplication38'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication38-desktop:1.0'
...
helm install --name ticketsampleapplication38-5076 ./helm
if [ $? -eq 0 ]; then
